...
export default function Services()
{
    ...
    return(
        ...
        <div className="bg-[#EBF4FF] p-10 md:py-12 py-2 pb-6">
            ...
            <div className="flex p-[13px] bg-[#018FFC] gap-4 items-center rounded-md cursor-pointer">
            ...
            <div className=" w-[97%]  md:w-3/4 lg:w-1/3">
...
export function ServicesSection(props){
    ...
    return(
        <>
          <div className=" servicesDiv flex p-[13px]  bg-[#ffffff] gap-4 items-center rounded-md">
