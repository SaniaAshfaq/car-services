...
export default function Footer()
{
    return(
        ...
        <div className="lg:w-[300px] flex flex-col lg:items-start lg:justify-start items-center justify-center  " data-aos="fade-up">
        ...
        <div   data-aos="fade-up">
            ...
            <button className=" bg-[#018FFC] text-white py-3 px-6 font-Roboto font-medium hover:bg-[#045fa5] rounded-md my-2 md:my-0" >Register</button>
        </div>
        </div>
