...
export default function Locate()
{
    return(
        ...
        <h1 className=" text-[35px] md:text-[40px] tracking-tight font-Oswald leading-[50.9px] text-center font-semibold"  data-aos="fade-down-right">You are here. So are we!</h1>

        <div className="bg-white py-1  md:w-2/5 rounded-md flex w-4/5 border border-grey"  data-aos="fade-down-right">
